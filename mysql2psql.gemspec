...
Gem::Specification.new do |s|
  ...
  s.files = [
    ".gitignore",
     ...
     "test/fixtures/config_localmysql_to_file_convert_all.yml",
     "test/fixtures/config_localmysql_to_file_convert_nothing.yml",
     "test/fixtures/config_localmysql_to_file_data_only.yml",
     "test/fixtures/config_localmysql_to_file_schema_only.yml",
